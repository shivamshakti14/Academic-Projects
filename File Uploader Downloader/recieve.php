...
<br>
 <form>
<input class="MyButton2" type="button" value="Send Files" onclick="window.location.href='index.php'" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input class="MyButton1" type="button" value="Recieve Files" onclick="window.location.href='recieve.php'" />
</form> 
<br>
<hr>
<br>
	<h2>
		<form action="xxx.php" method="POST" enctype="multipart/form-data">
			...
			<div class="browse">Enter File-ID for Recieving  : 	
			<input type="text" name="id" >
			<br>
			<br>
			<br>
			<div class="browse">Enter password  : 	
			<input type="password" name="pass2" >
				<br>
	<font color="black" size="2.5">(Don't  write anything for non Protected Files)</font>
<br>
	<input type="submit" class="styled-button-10" value="Get File now !" />
	<style type="text/css"> 
.styled-button-10 {
	background:#5CCD00;
